...
def make_basket(num_orders):
	...
	Trade_Dump = client.open("IGN Execution Template R2").worksheet('Large_TopModel')
	...
	tranche_info = client.open('IGN Execution Template R2').worksheet('top_IGN_Tranches')
	...
	#this number is set by the GUI now
	#num_orders = 5
	...
	'''
	#function that, when called, switches the buy&sell fields. 
	def exit_basket():
	...
	#create basket
	basket_file = open('IGN_Large_TopModel_Basket.bsk', 'w')
