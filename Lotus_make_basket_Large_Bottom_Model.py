...
def make_basket(num_orders):
	...
	Trade_Dump = client.open("Lotus Execution Template R2").worksheet('Large_BottomModel')
	...
	tranche_info = client.open('Lotus Execution Template R2').worksheet('bottom_Lotus_Tranches')
	...
	#create basket 
	basket_file = open('Lotus_Large_BottomModel_Basket.bsk', 'w')
